...
def research_menu():
    while True:
        ...
        elif c=="4": show_dict("Evidence Build Complete",progress_runner("Rebuilding evidence pairs",rebuild_evidence))
        elif c=="5": export_evidence_csv()
        elif c=="6": return
...
def model_explorer():
    ...
    t=Table(title="Model Explorer",header_style="bold cyan"); t.add_column("Field"); t.add_column("Value")
    ...
    if links:
        ...
        console.print(lt)
    if evidence: render_evidence(evidence,"Evidence involving this model")
    pause()
...
def texture_explorer():
    ...
    links=db.links_for_texture(tex["path"]); db.close()
    t=Table(title="Texture Explorer",header_style="bold cyan"); t.add_column("Field"); t.add_column("Value")
...
def duplicates_menu():
    ...
    t=Table(title="Duplicate Model Hashes",header_style="bold cyan"); t.add_column("#",justify="right"); t.add_column("Copies",justify="right"); t.add_column("Size",justify="right"); t.add_column("SHA")
...
def families_menu():
    ...
    console.print(t)
    tt=Table(title="Top Texture Families",header_style="bold cyan"); tt.add_column("#",justify="right"); tt.add_column("Name"); tt.add_column("Method"); tt.add_column("Members",justify="right")
...
def stats():
    ...
    console.print(t)
    ft=Table(title="Texture Formats",header_style="bold cyan"); ft.add_column("Format"); ft.add_column("Count",justify="right")
